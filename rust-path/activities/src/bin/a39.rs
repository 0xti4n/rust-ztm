            ...
            match receiver.recv() {
                Ok(msg) => match msg {
                    LightMsg::ChangeColor(r, g, b) => {
                        println!("Change color {}", "     ".on_truecolor(r, g, b));
                        match light_status {
                            LightStatus::On => println!("ligth on"),
                            LightStatus::Off => println!("ligth off"),
                        }
                    }
                    LightMsg::On => {
                        println!("Turned ligth on");
                        light_status = LightStatus::On
                    }
                    LightMsg::Off => {
                        println!("Turned ligth off");
